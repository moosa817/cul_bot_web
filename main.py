...
async def send_message_to_specific_channel(message='pinged',id=868218686366949416):
...
def index():
    asyncio.run_coroutine_threadsafe(send_message_to_specific_channel('pinged',868218686366949416),bot.loop)
